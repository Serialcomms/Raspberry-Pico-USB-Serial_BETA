...
&emsp; [CoolTerm](https://freeware.the-meiers.org/) is recommended for signalling testing [DSR/DCD/Ring](<img src="screenshots/coolterm_pico.png" alt="coolterm_pico" title="CoolTerm Pico" width="25%" height="25%">)
