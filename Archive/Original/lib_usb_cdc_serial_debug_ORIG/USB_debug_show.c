...
void show_notify_line_state() {
  ...
  uart_printf("CDC line state notification on EP1, DTR=%s, RTS=%s\n\r", 
...
void show_send_line_notification() {
  ...
  uart_printf("Sending CDC line state notification on EP1, Request Type=%02X, Data=%04X, DCD=%s, DSR=%s, RI=%s\n\r", 
