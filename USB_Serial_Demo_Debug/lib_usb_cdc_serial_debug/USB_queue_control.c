...
bool queue_wait_for_capacity_to_pico(uint8_t EP_NUMBER, uint16_t required_capacity, uint16_t wait_milliseconds) {
  ...
  do {
    ...
    queue_capacity = get_queue_free_to_pico(EP_NUMBER);
