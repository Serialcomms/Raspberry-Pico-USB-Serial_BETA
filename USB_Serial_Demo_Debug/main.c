...
#include "lib_usb_cdc_serial_debug/include/USB_uart_printf.h"
#include "lib_usb_cdc_serial_debug/API_usb_serial.h"
...
void init_pico_datetime() {
    ...
    if (!datetime_is_set) {
        ...
        uart_printf("Error setting Pico DateTime - check settings above\n\r");
