...
static inline void __not_in_flash_func(usb_handle_buffer_status_host)(uint8_t EP_NUMBER) {

  void *handler_address = get_host_endpoint_handler(EP_NUMBER);
...
static inline void __not_in_flash_func(usb_handle_buffer_status_pico)(uint8_t EP_NUMBER) {

  void *handler_address = get_pico_endpoint_handler(EP_NUMBER);
