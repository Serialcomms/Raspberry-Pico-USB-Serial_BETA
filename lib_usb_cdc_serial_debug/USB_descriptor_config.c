...
const uint8_t pico_config_descriptor[] = {
  ...
  0x07, 0x05, 0x83, 0x03, 0x10, 0x00, 0x01,                       // Endpoint Descriptor: EP3 In - (max packet size = 16)
  
  0x09, 0x04, 0x01, 0x00, 0x02, 0x0A, 0x00, 0x00, 0x00,           // CDC Data Class Interface Descriptor: CDC Data 
  0x07, 0x05, 0x81, 0x02, 0x40, 0x00, 0x00,                       // Endpoint Descriptor: EP1 In  - Bulk Transfer Type
  0x07, 0x05, 0x01, 0x02, 0x40, 0x00, 0x00                        // Endpoint Descriptor: EP1 Out - Bulk Transfer Type
